...
# AgentServer is top-level public API; expose it via ``require 'signalwire'``.
...
# Generated read-side typed payloads: the SWML-verbs config types
# (core.swml_verbs_generated), the RELAY protocol types
...
# data classes carrying the wire shape; each emitted by a generator script.
require_relative 'signalwire/generated_payloads'

module SignalWire
  # Top-level convenience entry points — the client factory and the skill
  # registry helpers.
  ...
  #
  # The singleton registry stores factories by name. The class is
  ...
  #
  # Delegates to the singleton {SignalWire::Skills::SkillRegistry} instance so
