    ...
    module Namespaces
      module Generated
        ...
        class VideoRoomSessions < SignalWire::REST::BaseResource
          ...
          def list_members(id, request_options: nil, **params)
            @http.get(_path(id, 'members'), params.empty? ? nil : params, request_options: request_options)
          end

          def list_recordings(id, request_options: nil, **params)
            @http.get(_path(id, 'recordings'), params.empty? ? nil : params, request_options: request_options)
          end
        end
      end
    end
