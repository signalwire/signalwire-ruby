  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SubscriberAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SubscriberAddressPaginationResponse').
            #
            ...
            class SubscriberAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
