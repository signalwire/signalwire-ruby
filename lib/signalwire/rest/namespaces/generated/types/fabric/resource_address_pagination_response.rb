  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # ResourceAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'ResourceAddressPaginationResponse').
            #
            ...
            class ResourceAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
