  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # FreeswitchConnectorAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'FreeswitchConnectorAddressPaginationResponse').
            #
            ...
            class FreeswitchConnectorAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
