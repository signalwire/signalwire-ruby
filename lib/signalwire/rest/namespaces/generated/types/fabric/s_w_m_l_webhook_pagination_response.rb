  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SWMLWebhookPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SWMLWebhookPaginationResponse').
            #
            ...
            class SWMLWebhookPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
