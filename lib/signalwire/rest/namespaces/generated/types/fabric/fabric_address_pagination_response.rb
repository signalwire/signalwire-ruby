  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # FabricAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'FabricAddressPaginationResponse').
            #
            ...
            class FabricAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
