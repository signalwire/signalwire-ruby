  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # DialogflowAgentUpdateRequest — generated wire type from the 'fabric' spec (components/schemas 'DialogflowAgentUpdateRequest').
            #
            ...
            class DialogflowAgentUpdateRequest
              FIELDS = {
                'name' => :string,
                'say_enabled' => :boolean,
                'say' => :string,
