  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # FreeswitchConnectorUpdateRequest — generated wire type from the 'fabric' spec (components/schemas 'FreeswitchConnectorUpdateRequest').
            #
            ...
            class FreeswitchConnectorUpdateRequest
              FIELDS = {
                'name' => :string,
                'caller_id' => :string,
                'send_as' => :string
