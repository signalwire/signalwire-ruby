  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # FreeswitchConectorPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'FreeswitchConectorPaginationResponse').
            #
            ...
            class FreeswitchConectorPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
