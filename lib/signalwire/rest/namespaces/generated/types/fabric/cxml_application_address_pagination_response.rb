  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # CxmlApplicationAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'CxmlApplicationAddressPaginationResponse').
            #
            ...
            class CxmlApplicationAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
