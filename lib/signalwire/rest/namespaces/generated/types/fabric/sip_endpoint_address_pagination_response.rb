  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SipEndpointAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SipEndpointAddressPaginationResponse').
            #
            ...
            class SipEndpointAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
