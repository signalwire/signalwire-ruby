  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # RelayApplicationCreateRequest — generated wire type from the 'fabric' spec (components/schemas 'RelayApplicationCreateRequest').
            #
            ...
            class RelayApplicationCreateRequest
              FIELDS = {
                'name' => :string,
                'topic' => :string,
