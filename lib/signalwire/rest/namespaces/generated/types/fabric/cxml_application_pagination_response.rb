  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # CxmlApplicationPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'CxmlApplicationPaginationResponse').
            #
            ...
            class CxmlApplicationPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
