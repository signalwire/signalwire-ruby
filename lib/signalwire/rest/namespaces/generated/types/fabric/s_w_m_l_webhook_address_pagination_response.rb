  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SWMLWebhookAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SWMLWebhookAddressPaginationResponse').
            #
            ...
            class SWMLWebhookAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
