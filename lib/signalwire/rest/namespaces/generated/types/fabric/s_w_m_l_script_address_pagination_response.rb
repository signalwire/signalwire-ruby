  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SWMLScriptAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SWMLScriptAddressPaginationResponse').
            #
            ...
            class SWMLScriptAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
