  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # DialogFlowPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'DialogFlowPaginationResponse').
            #
            ...
            class DialogFlowPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
