  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # CXMLWebhookAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'CXMLWebhookAddressPaginationResponse').
            #
            ...
            class CXMLWebhookAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
