  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # RelayApplicationAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'RelayApplicationAddressPaginationResponse').
            #
            ...
            class RelayApplicationAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
