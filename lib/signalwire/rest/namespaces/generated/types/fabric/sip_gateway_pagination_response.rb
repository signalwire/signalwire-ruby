  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SipGatewayPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SipGatewayPaginationResponse').
            #
            ...
            class SipGatewayPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
