  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SubscriberSipEndpointRequestUpdate — generated wire type from the 'fabric' spec (components/schemas 'SubscriberSipEndpointRequestUpdate').
            #
            ...
            class SubscriberSipEndpointRequestUpdate
              FIELDS = {
                'username' => :string,
                'password' => :string,
                'caller_id' => :string,
