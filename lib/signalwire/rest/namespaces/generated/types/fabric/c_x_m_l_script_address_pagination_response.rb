  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # CXMLScriptAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'CXMLScriptAddressPaginationResponse').
            #
            ...
            class CXMLScriptAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
