  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SipEndpointPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SipEndpointPaginationResponse').
            #
            ...
            class SipEndpointPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
