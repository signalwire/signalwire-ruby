  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # CallFlowAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'CallFlowAddressPaginationResponse').
            #
            ...
            class CallFlowAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
