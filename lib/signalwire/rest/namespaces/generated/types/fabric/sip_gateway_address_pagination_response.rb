  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SipGatewayAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SipGatewayAddressPaginationResponse').
            #
            ...
            class SipGatewayAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
