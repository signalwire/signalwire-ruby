  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SubscriberSipEndpointRequest — generated wire type from the 'fabric' spec (components/schemas 'SubscriberSipEndpointRequest').
            #
            ...
            class SubscriberSipEndpointRequest
              FIELDS = {
                'username' => :string,
                'password' => :string,
                'caller_id' => :string,
