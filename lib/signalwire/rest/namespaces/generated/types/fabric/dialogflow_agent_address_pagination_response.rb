  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # DialogflowAgentAddressPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'DialogflowAgentAddressPaginationResponse').
            #
            ...
            class DialogflowAgentAddressPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
