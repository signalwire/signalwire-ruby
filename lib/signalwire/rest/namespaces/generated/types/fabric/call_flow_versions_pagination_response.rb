  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # CallFlowVersionsPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'CallFlowVersionsPaginationResponse').
            #
            ...
            class CallFlowVersionsPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
