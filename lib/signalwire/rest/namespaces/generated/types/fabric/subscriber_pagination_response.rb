  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SubscriberPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SubscriberPaginationResponse').
            #
            ...
            class SubscriberPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
