  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SwmlScriptPaginationresponse — generated wire type from the 'fabric' spec (components/schemas 'SwmlScriptPaginationresponse').
            #
            ...
            class SwmlScriptPaginationresponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
