  ...
  module REST
    module Namespaces
      module Generated
        module Types
          module Fabric
            # SubscriberSipEndpointPaginationResponse — generated wire type from the 'fabric' spec (components/schemas 'SubscriberSipEndpointPaginationResponse').
            #
            ...
            class SubscriberSipEndpointPaginationResponse
              FIELDS = {
                'self' => :string,
                'first' => :string,
                'next' => :string,
