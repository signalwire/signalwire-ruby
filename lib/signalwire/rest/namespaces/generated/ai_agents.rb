...
# rubocop:disable Layout/LineLength, Metrics/AbcSize, Metrics/MethodLength, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity, Naming/VariableName, Naming/MethodParameterName
...
module SignalWire
  module REST
    module Namespaces
      module Generated
        # AiAgents — REST resource for the fabric API (base FabricResource).
...
# rubocop:enable Layout/LineLength, Metrics/AbcSize, Metrics/MethodLength, Metrics/CyclomaticComplexity, Metrics/PerceivedComplexity, Naming/VariableName, Naming/MethodParameterName
