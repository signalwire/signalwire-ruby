    ...
    module Namespaces
      module Generated
        ...
        class SipGateways < FabricResource
          ...
          def create(name:, uri:, encryption:, ciphers:, codecs:, extras: {}, request_options: nil, **kwargs)
            body = {}
            body['name'] = name
            body['uri'] = uri
          ...
          def update(resource_id, name: nil, uri: nil, encryption: nil, ciphers: nil, codecs: nil, extras: {}, request_options: nil, **kwargs)
            body = {}
