    ...
    module Namespaces
      module Generated
        ...
        class PhoneNumbers < SignalWire::REST::CrudResource
          ...
          def set_swml_webhook(resource_id, url:, extra: {}, **kwargs)
            body = { 'call_handler' => 'relay_script' }
            body['call_relay_script_url'] = url
            update(resource_id, **body.transform_keys(&:to_sym), **extra, **kwargs)
          end

          def set_cxml_webhook(resource_id, url:, fallback_url: nil, status_callback_url: nil, extra: {}, **kwargs)
          ...
          def set_cxml_application(resource_id, application_id:, extra: {}, **kwargs)
            body = { 'call_handler' => 'laml_application' }
            body['call_laml_application_id'] = application_id
            update(resource_id, **body.transform_keys(&:to_sym), **extra, **kwargs)
          end

          def set_ai_agent(resource_id, agent_id:, extra: {}, **kwargs)
            body = { 'call_handler' => 'ai_agent' }
            body['call_ai_agent_id'] = agent_id
            update(resource_id, **body.transform_keys(&:to_sym), **extra, **kwargs)
          end

          def set_call_flow(resource_id, flow_id:, version: nil, extra: {}, **kwargs)
          ...
          def set_relay_application(resource_id, name:, extra: {}, **kwargs)
            body = { 'call_handler' => 'relay_application' }
            body['call_relay_application'] = name
            update(resource_id, **body.transform_keys(&:to_sym), **extra, **kwargs)
          end

          def set_relay_topic(resource_id, topic:, status_callback_url: nil, extra: {}, **kwargs)
