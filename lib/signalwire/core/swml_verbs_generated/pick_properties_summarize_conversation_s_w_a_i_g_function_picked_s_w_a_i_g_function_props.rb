...
module SignalWire
  ...
  module Core
    ...
    module SwmlVerbsGenerated
      # PickPropertiesSummarizeConversationSWAIGFunctionPickedSWAIGFunctionProps — generated read-side payload (schema.json $defs schema 'PickPropertiesSummarizeConversationSWAIGFunctionPickedSWAIGFunctionProps').
      #
