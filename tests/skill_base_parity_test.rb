...
class ParitySkill < SignalWire::Skills::SkillBase
  def name;        'parity_skill'; end
  def description; 'Parity test skill'; end
  def supports_multiple_instances?; true; end

  def required_env_vars; ['PARITY_REQUIRED_VAR']; end
  def required_packages; ['json']; end # stdlib gem, always loadable
