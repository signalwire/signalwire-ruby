...
class OutboundConsumer < Signalwire::Relay::Consumer
  def ready
    ...
    result = dial_result.call.prompt_tts collect: collect_params, sentence: 'how many hamburgers would you like to order?')

    dial_result.call.play_tts sentence: "You ordered #{result.result} hamburgers. Thank you!"
