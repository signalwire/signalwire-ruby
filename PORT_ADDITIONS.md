...
signalwire.relay.call.AIAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete AIAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.CollectAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete CollectAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.CollectAction.volume: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete CollectAction (the reference declares volume on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.DetectAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete DetectAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.FaxAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete FaxAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.PayAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete PayAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.PlayAction.pause: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete PlayAction (the reference declares pause on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.PlayAction.resume: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete PlayAction (the reference declares resume on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.PlayAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete PlayAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.PlayAction.volume: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete PlayAction (the reference declares volume on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.RecordAction.pause: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete RecordAction (the reference declares pause on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.RecordAction.resume: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete RecordAction (the reference declares resume on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.RecordAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete RecordAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.StandaloneCollectAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete StandaloneCollectAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.StreamAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete StreamAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.TapAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete TapAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
signalwire.relay.call.TranscribeAction.stop: port-only: Ruby flattens the abstract StoppableAction/PausableAction/VolumeAction mixin methods onto the concrete TranscribeAction (the reference declares stop on the abstract base; §H abstract-action-base surface analog)
